...
def contouring():
	...
	return render_template('contouring.html', fronttxt=json.dumps(fronttxt), sidetxt=json.dumps(sidetxt),
...
def measurements():
	...
	for contour in contours:
		if contour != 'CARD':
			...
			profile[contour] = algorithm(deltaTuple, pixelsPerInchFront, pixelsPerInchSide)
